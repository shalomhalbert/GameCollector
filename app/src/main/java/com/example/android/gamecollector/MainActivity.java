 ...
 * MainActivity which displays user's personal collection
 */
...
public class MainActivity extends AppCompatActivity{
    ...
    /*Handles tapping the FloatingActionButton by starting AddCollectableActivity*/
    private void floatingActionButtonListner() {
        FloatingActionButton floatingActionButton = (FloatingActionButton)
                findViewById(R.id.add_floating_action_button);

        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent changeActivity = new Intent(getApplicationContext(),
                        AddCollectableActivity.class);
